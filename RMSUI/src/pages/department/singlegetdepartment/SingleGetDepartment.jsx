  ...
  return (
    <div className="flex flex-col items-start  min-h-screen ">
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li>
            <div className="flex items-center">
              ...
              <Link to="/home/department" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Departments</Link>
            </div>
          </li>
      ...
      <div className="w-full px-8 py-4 bg-white rounded-lg shadow-lg dark:bg-white relative">
        <Link to={`/departments/edit/${id}`} className="absolute top-4 right-4 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded hover:bg-blue-700">
          Edit
        </Link>
