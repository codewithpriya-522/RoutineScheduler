...
const TeacherNav = () => {
    ...
    const navItems = [
        { name: 'Dashboard', icon: <MdOutlineDashboard />, path: '/teacherHome' },
        { name: 'Schedules', icon: <MdOutlineSchedule />, path: '/teacherHome/schedule' },
        { name: 'Attendance', icon: <MdOutlineCheckCircle />, path: '/teacherHome/attendance' },
        { name: 'Courses', icon: <MdOutlineBook />, path: '/teacherHome/courses' },
        { name: 'Syllabus', icon: <MdOutlineSchool />, path: '/teacherHome/syllabus' },
        { name: 'Profile', icon: <MdOutlineAccountCircle />, path: '/teacherHome/profile' },
    ];
