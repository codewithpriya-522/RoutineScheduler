...
const Navbar = () => {
    ...
    const navItems = [
        ...
        { name: 'Schedules', icon: <SchedulesIcon />, path: '/schedule' },
        { name: 'Teachers', icon: <TeachersIcon />, path: '/teachers' },
        { name: 'Published', icon: <PublishedIcon />, path: '/published' },
        { name: 'Today\'s Scheduled', icon: <ScheduledIcon />, path: '/scheduled', extra: '+2' },
        { name: 'Bookmarks', icon: <BookmarksIcon />, path: '/bookmarks' }
    ];
